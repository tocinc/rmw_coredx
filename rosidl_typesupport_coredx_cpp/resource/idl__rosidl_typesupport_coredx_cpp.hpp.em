// generated from rosidl_typesupport_coredx_cpp/resource/idl__rosidl_typesupport_coredx_cpp.hpp.em
// with input from @(package_name):@(interface_path)
// generated code does not contain a copyright notice

@{
#######################################################################
# EmPy template for generating <idl>__rosidl_typesupport_coredx_cpp.hpp files
#
# Context:
#  - package_name (string)
...
header_guard_variable = '__'.join([x.upper() for x in include_parts]) + \
    '__ROSIDL_TYPESUPPORT_COREDX_CPP_HPP_'
...
for service in content.get_elements_of_type(Service):
    TEMPLATE(
        'srv__rosidl_typesupport_coredx_cpp.hpp.em',
