...
#ifndef ROSIDL_TYPESUPPORT_COREDX_CPP__SERVICE_TYPE_SUPPORT_H_
#define ROSIDL_TYPESUPPORT_COREDX_CPP__SERVICE_TYPE_SUPPORT_H_
...
typedef struct service_type_support_callbacks_t
{
  ...
  bool (* send_response)(void * replier, const rmw_request_id_t * request_header, const void * ros_response);
  ...
  void *(*get_request_datawriter)(void * untyped_requester);
  // Function to get the type erased dds reply datawriter for the requester
  void *(*get_reply_datareader)(void * untyped_requester);
  // Function to get the type erased dds request datawriter for the replier
  void *(*get_request_datareader)(void * untyped_replier);
  // Function to get the type erased dds reply datawriter for the replier
  void *(*get_reply_datawriter)(void * untyped_replier);
} service_type_support_callbacks_t;

#endif  /* ROSIDL_TYPESUPPORT_COREDX_CPP__SERVICE_TYPE_SUPPORT_H_ */
