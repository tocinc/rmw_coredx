...
const rosidl_service_type_support_t * get_service_type_support_handle_coredx();
...
const rosidl_service_type_support_t * get_service_type_support_handle()
{
  ...
  return rosidl_typesupport_coredx_cpp::get_service_type_support_handle_coredx<T>();
}
