...
foreach(_idl_file ${rosidl_generate_interfaces_ABS_IDL_FILES})
  ...
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_.hh")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_.cc")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataReader.hh")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataReader.cc")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataWriter.hh")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataWriter.cc")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_TypeSupport.hh")
  list(APPEND _generated_external_files "${_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_TypeSupport.cc")
...
set(target_dependencies
  ...
  "${rosidl_typesupport_coredx_cpp_TEMPLATE_DIR}/idl__rosidl_typesupport_coredx_cpp.hpp.em"
  "${rosidl_typesupport_coredx_cpp_TEMPLATE_DIR}/idl__dds_coredx__type_support.cpp.em"
