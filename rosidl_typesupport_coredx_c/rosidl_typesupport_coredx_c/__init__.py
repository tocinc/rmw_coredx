...
def generate_typesupport_coredx_c(args):
    template_dir = args['template_dir']
    mapping_msgs = {
        os.path.join(template_dir, 'msg__rosidl_typesupport_coredx_c.h.em'):
        '%s__rosidl_typesupport_coredx_c.h',
        os.path.join(template_dir, 'msg__type_support_c.cpp.em'):
        '%s__type_support_c.cpp',
    }

    mapping_srvs = {
        os.path.join(template_dir, 'srv__rosidl_typesupport_coredx_c.h.em'):
        '%s__rosidl_typesupport_coredx_c.h',
        ...
        if extension == '.msg':
            ...
            for template_file, generated_filename in mapping_msgs.items():
                ...
                if generated_filename.endswith('.cpp'):
                    generated_file = os.path.join(generated_file, 'dds_coredx_c')
