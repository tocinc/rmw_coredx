...
foreach(_idl_file ${rosidl_generate_interfaces_ABS_IDL_FILES})
  ...
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_.hh")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_.cc")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataReader.hh")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataReader.cc")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataWriter.hh")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_DataWriter.cc")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_TypeSupport.hh")
  list(APPEND _generated_external_files "${_dds_output_path}/${_parent_folder}/dds_coredx/${_idl_name}_TypeSupport.cc")
  list(APPEND _generated_files "${_output_path}/${_parent_folder}/${_header_name}__rosidl_typesupport_coredx_c.h")
  list(APPEND _generated_files "${_output_path}/${_parent_folder}/dds_coredx/${_header_name}__type_support_c.cpp")
  list(APPEND _dds_idl_files "${_dds_idl_base_path}/${PROJECT_NAME}/${_parent_folder}/dds_coredx/${_idl_name}_.idl")
endforeach()
...
set(target_dependencies
  ...
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/idl__dds_coredx__type_support_c.cpp.em"
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/idl__rosidl_typesupport_coredx_c.h.em"
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/msg__type_support_c.cpp.em"
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/msg__rosidl_typesupport_coredx_c.h.em"
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/srv__type_support_c.cpp.em"
  "${rosidl_typesupport_coredx_c_TEMPLATE_DIR}/srv__rosidl_typesupport_coredx_c.h.em"
